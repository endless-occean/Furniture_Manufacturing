...
public class Accountant extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        Communal_Payments_Btn = new javax.swing.JButton();
        ...
        Communal_Payments_Btn.setBackground(new java.awt.Color(102, 0, 0));
        Communal_Payments_Btn.setFont(new java.awt.Font("Times New Roman", 0, 20)); // NOI18N
        Communal_Payments_Btn.setForeground(new java.awt.Color(255, 255, 255));
        Communal_Payments_Btn.setText("Коммунальные платежи");
        Communal_Payments_Btn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Communal_Payments_BtnActionPerformed(evt);
            }
        });

        Salary_Btn.setBackground(new java.awt.Color(102, 0, 0));
        Salary_Btn.setFont(new java.awt.Font("Times New Roman", 0, 20)); // NOI18N
        Salary_Btn.setForeground(new java.awt.Color(255, 255, 255));
        Salary_Btn.setText("Рассчёт заработной платы");
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                            ...
                            .addComponent(Communal_Payments_Btn, javax.swing.GroupLayout.PREFERRED_SIZE, 257, javax.swing.GroupLayout.PREFERRED_SIZE))
                        .addGap(56, 56, 56))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(Communal_Payments_Btn)
                .addGap(18, 18, 18)
    ...
    private void Communal_Payments_BtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Communal_Payments_BtnActionPerformed
        new Communal_Payments().setVisible(true);
        this.dispose();
    }//GEN-LAST:event_Communal_Payments_BtnActionPerformed
    ...
    private javax.swing.JButton Communal_Payments_Btn;
